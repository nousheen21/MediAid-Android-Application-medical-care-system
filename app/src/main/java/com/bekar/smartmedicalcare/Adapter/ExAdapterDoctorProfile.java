...
public class ExAdapterDoctorProfile extends BaseExpandableListAdapter {
    ...
    public ExAdapterDoctorProfile(Context mContext,
    ...
    private void deleteChild(PatientMedicalConditionsModel obj) {
        firestore.collection("Doctor").document(user.getUid())
