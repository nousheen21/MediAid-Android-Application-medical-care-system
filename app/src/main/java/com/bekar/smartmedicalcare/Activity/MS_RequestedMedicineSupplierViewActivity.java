...
public class MS_RequestedMedicineSupplierViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storeName = intent.getStringExtra(MS_StoreListActivity.storeName);
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            MS_RequestedMedicineList adapter = new MS_RequestedMedicineList(MS_RequestedMedicineSupplierViewActivity.this,medicineList);
